---
title: "DA3 - Assignment 2 - Summary review"
...
data <- data %>% filter(f_property_type %in% c("Entire condominium (condo)", "Entire guest suite",
...
Our other plot, the partial dependence plot shows the direction and shape of association of the number of accommodates with price.
...
We use three subsamples, first we devide the data to small (apartments accommodating 3 or less people) and large apartments.
With the second subsample we compare the performance of our model in six neighbourhoods.
Lastly we do the same with two types of properties, entire rental units and entire condominiums.
...
kable( result_3,
       ...
       caption = 'Subsets') %>% kable_styling(latex_options = c("hold_position","scale_down"))
```
